...
#include "SpriteFactoryAttorneyToEngine.h"

#include "SceneManagerAttorneyToEngine.h"
...
void APlusPlusEngine::TerminateGame()
{
	...
	SceneManagerAttorneyToEngine::Terminate();
	SpriteFactoryAttorneyToEngine::Terminate();
	TimeManagerAttorneyToAPlusPlusEngine::Terminate();
...
void APlusPlusEngine::SetSolidRendering()
{
	Instance().Engine::SetSolidRender();
}

void APlusPlusEngine::SetWireFrameRendering()
{
	Instance().Engine::SetWireRender();
}
